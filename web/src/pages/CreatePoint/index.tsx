...
const CreatePoint: React.FC = () => {
  ...
  useEffect(() => {
    ...
    .then(response => {
      const parsedUfs: IUF[] = response.data.map(({id, sigla, nome}) => (
        { 
          id, 
          initials: sigla, 
          name: nome,
  ...
  useEffect(() => {
    ...
    .then(response => {
      const parsedCities: ICity[] = response.data.map(({ id, nome }) => (
        {
          id,
          name: nome,
        }
          ...
          <div className="field-group">
            <div className="field">
              ...
              <select name="uf" id="uf" value={selectedUf} onChange={handleSelectUf}>
                ...
                {
                  ufs.map(uf => (
                    <option key={uf.id} value={uf.initials}>{uf.initials}</option>
                  ))
                }
              </select>
            </div>
